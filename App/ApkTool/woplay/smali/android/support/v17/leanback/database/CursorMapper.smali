...
.method public convert(Landroid/database/Cursor;)Ljava/lang/Object;
    ...
    .line 46
    iget-object p1, p0, Landroid/support/v17/leanback/database/CursorMapper;->mCursor:Landroid/database/Cursor;

    invoke-virtual {p0, p1}, Landroid/support/v17/leanback/database/CursorMapper;->bindColumns(Landroid/database/Cursor;)V

    .line 48
    :cond_0
    iget-object p1, p0, Landroid/support/v17/leanback/database/CursorMapper;->mCursor:Landroid/database/Cursor;

    invoke-virtual {p0, p1}, Landroid/support/v17/leanback/database/CursorMapper;->bind(Landroid/database/Cursor;)Ljava/lang/Object;
