...
.method constructor <init>(Landroid/support/v17/leanback/graphics/CompositeDrawable$ChildDrawable;Landroid/support/v17/leanback/graphics/CompositeDrawable;Landroid/content/res/Resources;)V
    ...
    invoke-static {p3, v1}, Landroid/support/v4/graphics/drawable/DrawableCompat;->setLayoutDirection(Landroid/graphics/drawable/Drawable;I)Z
    ...
    .line 273
    :goto_1
    iget-object v0, p1, Landroid/support/v17/leanback/graphics/CompositeDrawable$ChildDrawable;->mBoundsRule:Landroid/support/v17/leanback/graphics/BoundsRule;
    ...
    iget-object p1, p1, Landroid/support/v17/leanback/graphics/CompositeDrawable$ChildDrawable;->mBoundsRule:Landroid/support/v17/leanback/graphics/BoundsRule;

    invoke-direct {v0, p1}, Landroid/support/v17/leanback/graphics/BoundsRule;-><init>(Landroid/support/v17/leanback/graphics/BoundsRule;)V
    ...
    .line 276
    :cond_2
    new-instance p1, Landroid/support/v17/leanback/graphics/BoundsRule;

    invoke-direct {p1}, Landroid/support/v17/leanback/graphics/BoundsRule;-><init>()V

    iput-object p1, p0, Landroid/support/v17/leanback/graphics/CompositeDrawable$ChildDrawable;->mBoundsRule:Landroid/support/v17/leanback/graphics/BoundsRule;

    .line 278
    :goto_2
    iput-object p3, p0, Landroid/support/v17/leanback/graphics/CompositeDrawable$ChildDrawable;->mDrawable:Landroid/graphics/drawable/Drawable;
...
.method static synthetic access$000(Landroid/support/v17/leanback/graphics/CompositeDrawable$ChildDrawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 243
    iget-object p0, p0, Landroid/support/v17/leanback/graphics/CompositeDrawable$ChildDrawable;->mDrawable:Landroid/graphics/drawable/Drawable;
...
.method updateBounds(Landroid/graphics/Rect;)V
    ...
    .line 301
    iget-object p1, p0, Landroid/support/v17/leanback/graphics/CompositeDrawable$ChildDrawable;->mDrawable:Landroid/graphics/drawable/Drawable;

    iget-object v0, p0, Landroid/support/v17/leanback/graphics/CompositeDrawable$ChildDrawable;->adjustedBounds:Landroid/graphics/Rect;
