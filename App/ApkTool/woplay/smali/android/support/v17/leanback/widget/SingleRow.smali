...
.method protected final appendVisibleItems(IZ)Z
    ...
    invoke-interface {v4}, Landroid/support/v17/leanback/widget/Grid$Provider;->getCount()I
    ...
    invoke-interface {v3, v0, v2, v4, v1}, Landroid/support/v17/leanback/widget/Grid$Provider;->createItem(IZ[Ljava/lang/Object;Z)I
    ...
    invoke-interface {v5, v4}, Landroid/support/v17/leanback/widget/Grid$Provider;->getSize(I)I
    ...
    .line 124
    :goto_1
    iput v0, p0, Landroid/support/v17/leanback/widget/SingleRow;->mLastVisibleIndex:I
    ...
    .line 117
    :goto_3
    iput v0, p0, Landroid/support/v17/leanback/widget/SingleRow;->mFirstVisibleIndex:I
...
.method public collectAdjacentPrefetchPositions(IILandroid/support/v7/widget/RecyclerView$LayoutManager$LayoutPrefetchRegistry;)V
    ...
    iget v1, p0, Landroid/support/v17/leanback/widget/SingleRow;->mFirstVisibleIndex:I

    invoke-interface {v0, v1}, Landroid/support/v17/leanback/widget/Grid$Provider;->getEdge(I)I

    move-result v0

    iget-boolean v1, p0, Landroid/support/v17/leanback/widget/SingleRow;->mReversedFlow:Z
    ...
    iget v1, p0, Landroid/support/v17/leanback/widget/SingleRow;->mLastVisibleIndex:I
...
.method protected final findRowMax(ZI[I)I
    ...
    .line 190
    :cond_0
    iget-boolean p1, p0, Landroid/support/v17/leanback/widget/SingleRow;->mReversedFlow:Z

    if-eqz p1, :cond_1

    iget-object p1, p0, Landroid/support/v17/leanback/widget/SingleRow;->mProvider:Landroid/support/v17/leanback/widget/Grid$Provider;

    invoke-interface {p1, p2}, Landroid/support/v17/leanback/widget/Grid$Provider;->getEdge(I)I
    ...
    iget-object p3, p0, Landroid/support/v17/leanback/widget/SingleRow;->mProvider:Landroid/support/v17/leanback/widget/Grid$Provider;

    invoke-interface {p3, p2}, Landroid/support/v17/leanback/widget/Grid$Provider;->getSize(I)I
...
.method public final getItemPositionsInRows(II)[Landroid/support/v4/util/CircularIntArray;
    ...
    .line 170
    iget-object p1, p0, Landroid/support/v17/leanback/widget/SingleRow;->mTmpItemPositionsInRows:[Landroid/support/v4/util/CircularIntArray;
...
.method public final getLocation(I)Landroid/support/v17/leanback/widget/Grid$Location;
    ...
    .line 36
    iget-object p1, p0, Landroid/support/v17/leanback/widget/SingleRow;->mTmpLocation:Landroid/support/v17/leanback/widget/Grid$Location;
...
.method protected final prependVisibleItems(IZ)Z
    ...
    invoke-interface {v4, v2, v1, v5, v1}, Landroid/support/v17/leanback/widget/Grid$Provider;->createItem(IZ[Ljava/lang/Object;Z)I
