...
.method public final getScroll(I)I
    ...
    .line 317
    iget p1, p0, Landroid/support/v17/leanback/widget/WindowAlignment$Axis;->mMinEdge:I
    ...
    .line 320
    iget p1, p0, Landroid/support/v17/leanback/widget/WindowAlignment$Axis;->mMaxScroll:I
    ...
    .line 326
    iget v4, p0, Landroid/support/v17/leanback/widget/WindowAlignment$Axis;->mPaddingMax:I
    ...
    .line 331
    iget p1, p0, Landroid/support/v17/leanback/widget/WindowAlignment$Axis;->mMaxEdge:I
    ...
    .line 334
    iget p1, p0, Landroid/support/v17/leanback/widget/WindowAlignment$Axis;->mMinScroll:I
...
.method public final getWindowAlignment()I
    ...
    .line 85
    iget v0, p0, Landroid/support/v17/leanback/widget/WindowAlignment$Axis;->mWindowAlignment:I
...
.method public final getWindowAlignmentOffsetPercent()F
    ...
    .line 129
    iget v0, p0, Landroid/support/v17/leanback/widget/WindowAlignment$Axis;->mWindowAlignmentOffsetPercent:F
...
.method final setPreferKeylineOverHighEdge(Z)V
    ...
    .line 99
    iget p1, p0, Landroid/support/v17/leanback/widget/WindowAlignment$Axis;->mPreferredKeyLine:I
    ...
    :goto_0
    iput p1, p0, Landroid/support/v17/leanback/widget/WindowAlignment$Axis;->mPreferredKeyLine:I
...
.method public final updateMinMax(IIII)V
    ...
    .line 237
    iget-boolean v2, p0, Landroid/support/v17/leanback/widget/WindowAlignment$Axis;->mReversedFlow:Z

    if-nez v2, :cond_0

    iget v2, p0, Landroid/support/v17/leanback/widget/WindowAlignment$Axis;->mWindowAlignment:I
    ...
    .line 240
    :goto_0
    iget v2, p0, Landroid/support/v17/leanback/widget/WindowAlignment$Axis;->mMinEdge:I

    iget v3, p0, Landroid/support/v17/leanback/widget/WindowAlignment$Axis;->mPaddingMin:I

    sub-int/2addr v2, v3

    iput v2, p0, Landroid/support/v17/leanback/widget/WindowAlignment$Axis;->mMinScroll:I

    goto :goto_1

    .line 243
    :cond_1
    invoke-virtual {p0, p3, p2}, Landroid/support/v17/leanback/widget/WindowAlignment$Axis;->calculateScrollToKeyLine(II)I
    ...
    .line 250
    :goto_2
    iget v2, p0, Landroid/support/v17/leanback/widget/WindowAlignment$Axis;->mMaxEdge:I
    ...
    iput v2, p0, Landroid/support/v17/leanback/widget/WindowAlignment$Axis;->mMaxScroll:I

    goto :goto_3

    .line 253
    :cond_4
    invoke-virtual {p0, p4, p2}, Landroid/support/v17/leanback/widget/WindowAlignment$Axis;->calculateScrollToKeyLine(II)I
    ...
    .line 257
    iget-boolean p1, p0, Landroid/support/v17/leanback/widget/WindowAlignment$Axis;->mReversedFlow:Z

    if-nez p1, :cond_9

    .line 258
    iget p1, p0, Landroid/support/v17/leanback/widget/WindowAlignment$Axis;->mWindowAlignment:I
    ...
    iget p2, p0, Landroid/support/v17/leanback/widget/WindowAlignment$Axis;->mMaxScroll:I
