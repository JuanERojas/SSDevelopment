...
*/	
	...
	$sql = "SELECT p.codigo AS pon, n.numero AS nap, c.codcliente AS cliente, c.`time` AS age FROM cliente AS c INNER JOIN nap AS n ON c.codnap = n.idnap INNER JOIN pon AS p ON n.codpon = p.codigo WHERE c.codcliente =".$cl." ORDER BY p.codigo, n.numero + 0;";
	if ($cl== -1) {
...
<div align="center">
	...
	<h4>
	<br>
	<form action="buscar.php" method="get" id="form">
		<table>
			<tr class="linea">
				<td><b><i>Num Cliente: </i></b></td>
				<td>
					<INPUT align="right" TYPE = "Text" NAME = "cl" id="cl" width="100" value="<?php echo $cl;?>">
				</td>
			</tr>
		</table>
		<br>
