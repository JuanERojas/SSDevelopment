...
*/
	...
	$sql = "SELECT t.nombre AS tecnico, COUNT(*) AS cant FROM reclamo r INNER JOIN tecnico AS t ON r.tecnico = t.idtecnico GROUP BY tecnico ORDER BY cant DESC LIMIT 10;";
	...
	$sql = "SELECT idreclamo, t.nombre AS tecnico, nodo, problema, numcliente, time FROM reclamo r INNER JOIN tecnico AS t ON r.tecnico = t.idtecnico;";
