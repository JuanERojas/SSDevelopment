...
<?php
	...
	?>
		<tr>
			...
			<th width='100'  align='left'><a href='stats4.php?nodo=<?php echo $r[2];?>&intervalo=<?php echo $intervalo;?>' target="_blank">
				<?php echo $r[2];?>
			</a></th>
...
<?php
	...
	?>
		<tr>
			<th width="230" align='left'><a href='stats4.php?nodo=<?php echo $panel;?>&intervalo=<?php echo $intervalo;?>' target="_blank">
				<?php echo $panel;?>
			</a></th>
