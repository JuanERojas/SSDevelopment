...
<?php
	...
	<hr>
	<br>
	<button class="button" onclick="window.open('gestion.php?cl=<?php echo $numcliente; ?>&ip=<?php echo $ipcliente; ?>','_blank');" target="_blank">Gestión</button>
...
<script>
	...
	setTimeout("location.href='gestionUbi.php?ip=172.31.1.42'",50);
</script>
</body>
</html>