...
*/
	...
	$sql = "SELECT nodo AS panel ,problema AS reclamo, COUNT(*) AS cant FROM reclamo r WHERE `time` > DATE_SUB(NOW(), INTERVAL '3:0:".$intervalo."' HOUR_SECOND) GROUP BY r.nodo, r.problema ORDER BY r.nodo, cant DESC LIMIT 20;";
	if($intervalo == -1){
		$sql = "SELECT nodo AS panel ,problema AS reclamo, COUNT(*) AS cant FROM reclamo r GROUP BY r.nodo, r.problema ORDER BY r.nodo, cant DESC LIMIT 20;";
	}
