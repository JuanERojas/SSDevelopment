...
*/
	...
	$sql = "SELECT n.nombre AS nodo, COUNT(*) AS cant FROM `ss-dbtk`.reclamo r INNER JOIN `ss-db`.panel AS p ON r.nodo = p.nombre INNER JOIN `ss-db`.nodo AS n ON p.nodo = n.idnodo GROUP BY n.nombre;";
