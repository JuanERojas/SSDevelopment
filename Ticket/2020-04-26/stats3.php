...
<head>
    ...
    <script type="text/javascript">
      ...
      google.charts.setOnLoadCallback(drawChartTipo);
	  google.charts.load('current', {'packages':['corechart']});
      google.charts.setOnLoadCallback(drawChartNodo);

      function drawChartTipo() {
		var porTipo = [];
...
?>	
      ...
      function drawChartNodo() {
		var porTipo = [];
		porTipo[ porTipo.length ] = ['Nodo', 'Cantidad'];
<?php
		foreach($porNodo as $p) {
?>		
		porTipo[ porTipo.length ] = ["<?php echo $p["nodo"];?>", <?php echo $p["cantidad"];?>];
<?php
		}
?>	
		var data = google.visualization.arrayToDataTable(porTipo)
        var options = {
			title: 'Reclamos por Nodo',
			backgroundColor: '#9BB579',
			legend: {
				alignment: 'center',
				position: 'top'
        ...
        var chart = new google.visualization.PieChart(document.getElementById('piechartPorNodo'));
        chart.draw(data, options);
      }
    </script>
...
<?php
	...
	?>
			<th width="230" align='left'><a href='stats4.php?nodo=<?php echo $nodo;?>&intervalo=<?php echo $intervalo;?>' target="_blank">
				<?php echo $nodo;?>
			</a>
			</th>
...
<?php
	...
	<br>
	<div align="center">
		<div id="piechartPorNodo" align="right" style="width: 800px; height: 500px;"></div>
	</div>
	<br>
	<br>
	<hr>
